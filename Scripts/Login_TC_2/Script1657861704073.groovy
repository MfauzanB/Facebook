...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Facebook  log in or sign up/input_Facebook helps you connect and share _ab63fc'), 
    'rpeJKHr3riHasVFmQn+Q9w==')

WebUI.click(findTestObject('Page_Facebook  log in or sign up/button_Log In1'))

WebUI.verifyElementPresent(findTestObject('Page_Facebook  log in or sign up/Button_home (1)'), 0)
